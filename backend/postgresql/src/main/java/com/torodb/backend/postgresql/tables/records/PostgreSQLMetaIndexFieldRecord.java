...
public class PostgreSQLMetaIndexFieldRecord extends MetaIndexFieldRecord<String[]> {
	 ...
	 */
	public PostgreSQLMetaIndexFieldRecord(String database, String collection, String index, Integer position, String[] tableRef, String name, FieldIndexOrdering fieldIndexOrdering) {
		super(PostgreSQLMetaIndexFieldTable.INDEX_FIELD);
    ...
    @Override
    public MetaIndexFieldRecord<String[]> values(String database, String collection, String index, Integer position, String[] tableRef, String name, FieldIndexOrdering fieldIndexOrdering) {
