...
public class PostgreSQLMetaFieldIndexRecord extends MetaFieldIndexRecord<String[]> {
	 ...
	 */
	public PostgreSQLMetaFieldIndexRecord(String database, String identifier, Integer position, String collection, String[] tableRef, String name, FieldType type, FieldIndexOrdering fieldIndexOrdering) {
		super(PostgreSQLMetaFieldIndexTable.FIELD_INDEX);
    ...
    @Override
    public MetaFieldIndexRecord<String[]> values(String database, String identifier, Integer position, String collection, String[] tableRef, String name, FieldType type, FieldIndexOrdering fieldIndexOrdering) {
