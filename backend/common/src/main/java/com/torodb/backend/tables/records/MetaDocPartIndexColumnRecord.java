...
public abstract class MetaDocPartIndexColumnRecord<TableRefType> extends UpdatableRecordImpl<MetaDocPartIndexColumnRecord<TableRefType>> 
        implements Record7<String, String, Integer, String, TableRefType, String, FieldIndexOrdering> {
	...
	@SuppressWarnings("unchecked")
    @Override
	public Row7<String, String, Integer, String, TableRefType, String, FieldIndexOrdering> fieldsRow() {
		return (Row7<String, String, Integer, String, TableRefType, String, FieldIndexOrdering>) super.fieldsRow();
	}
	...
	@SuppressWarnings("unchecked")
    @Override
	public Row7<String, String, Integer, String, TableRefType, String, FieldIndexOrdering> valuesRow() {
		return (Row7<String, String, Integer, String, TableRefType, String, FieldIndexOrdering>) super.valuesRow();
	}
     ...
     */
    @Override
    public MetaDocPartIndexColumnRecord<TableRefType> value1(String value) {
        setDatabase(value);
        return this;
    }
     ...
     */
    @Override
    public MetaDocPartIndexColumnRecord<TableRefType> value2(String value) {
     ...
     */
    @Override
    public MetaDocPartIndexColumnRecord<TableRefType> value3(Integer value) {
        setPosition(value);
        return this;
    }
     ...
     */
    @Override
    public MetaDocPartIndexColumnRecord<TableRefType> value4(String value) {
        setCollection(value);
        return this;
    }
     ...
     */
    @Override
    public MetaDocPartIndexColumnRecord<TableRefType> value5(TableRefType value) {
        setTableRef(value);
        return this;
    }
     ...
     */
    @Override
    public MetaDocPartIndexColumnRecord<TableRefType> value6(String value) {
        setIdentifier(value);
        return this;
    }
     ...
     */
    @Override
    public MetaDocPartIndexColumnRecord<TableRefType> value7(FieldIndexOrdering value) {
        setOrdering(value);
        return this;
    }
	 ...
	 */
    @Override
    public abstract MetaDocPartIndexColumnRecord<TableRefType> values(String database, String indexIdentifier, Integer position, String collection, TableRefType tableRef, String identifier, FieldIndexOrdering fieldIndexOrdering);

    public MetaDocPartIndexColumnRecord<TableRefType> values(String database, String indexIdentifier, Integer position, String collection, TableRef tableRef, String identifier, FieldIndexOrdering fieldIndexOrdering) {
        return values(database, indexIdentifier, position, collection, toTableRefType(tableRef), identifier, fieldIndexOrdering);
    }
    ...
    private final MetaDocPartIndexColumnTable<TableRefType, MetaDocPartIndexColumnRecord<TableRefType>> metaIndexFieldTable;
