...
public class SqlInterfaceDelegate implements SqlInterface {
    ...
    @Override
    public DidCursor getCollectionDidsWithFieldEqualsTo(DSLContext dsl, MetaDatabase metaDatabase, MetaCollection metaCol, MetaDocPart metaDocPart, MetaField metaField, KVValue<?> value)
            throws SQLException {
        return readInterface.getCollectionDidsWithFieldEqualsTo(dsl, metaDatabase, metaCol, metaDocPart, metaField, value);
    }

    @Override
    public DidCursor getAllCollectionDids(DSLContext dsl, MetaDatabase metaDatabase, MetaCollection metaCollection)
            throws SQLException {
        return readInterface.getAllCollectionDids(dsl, metaDatabase, metaCollection);
    }
    ...
    public void handleUserAndRetryException(Context context, SQLException sqlException) throws
            UserException {
