...
public class SchemaValidator {
	...
	public SchemaValidator(DSLContext dsl, String schemaName, String database) throws InvalidDatabaseSchemaException {
    ...
    private List<Index> getIndexes(String schemaName, Iterable<? extends Table> existingTables, Connection connection) {
    ...
    protected com.torodb.backend.meta.SchemaValidator.Index.ResultSetIterator getIndexIterator(String schemaName,
    ...
    private final Splitter COLUMN_TYPE_NAME_SPLITTER = Splitter.on('.');
                ...
                for (TableField field : table.fields()) {
                    if (field.getName().equals(columnName)) {
                        if (field.getSqlType() == columnType.getSQLType() &&
                            field.getTypeName().equals(COLUMN_TYPE_NAME_SPLITTER
    ...
    public TableField getColumn(String tableName, String columnName) {
        ...
        throw new IllegalArgumentException("Column " + columnName + " in table " + schemaName + "." + tableName + " not found");
    }
    ...
    public static class Index {
        ...
        - tableIndexStatistic - this identifies table statistics that are returned in conjuction with a table's 
         index descriptions 
        ...
        - PAGES long => When TYPE is tableIndexStatisic then this is the number of pages used for the 
    ...
    public static class Table {
        ...
        - SELF_REFERENCING_COL_NAME String => name of the designated "identifier" column of a 
