...
import com.torodb.poc.backend.AttributeReference.ArrayKey;
import com.torodb.poc.backend.AttributeReference.Key;
import com.torodb.poc.backend.AttributeReference.ObjectKey;
import com.torodb.poc.backend.D2RVisitor.Callback;
    ...
    public void visit(KVArray array, AttributeReference attributeReference, TableRef tableRef,
        ...
        for (KVValue<?> element : array) {
            ...
            if (element instanceof KVArray) {
                appendRowWithChildToArray(docPartData, parentRow, index, KVBoolean.TRUE);
            } else {
