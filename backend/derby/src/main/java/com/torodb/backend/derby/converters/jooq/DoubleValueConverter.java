...
public class DoubleValueConverter implements KVValueConverter<Double, Double, KVDouble> {
    ...
    public static final DataType<Double> DOUBLE_TYPE = new DefaultDataType<Double>(SQLDialect.DERBY, SQLDataType.DOUBLE, "DOUBLE");
    
    public static final DataTypeForKV<KVDouble> TYPE = DataTypeForKV.from(DOUBLE_TYPE, new DoubleValueConverter());
