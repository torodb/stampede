...
public class DerbyMetaDocPartIndexRecord extends MetaDocPartIndexRecord<JsonArray> {
    ...
    @Override
    public DerbyMetaDocPartIndexRecord values(String database, String identifier, String collection, JsonArray tableRef, Boolean unique) {
	 ...
	 */
	public DerbyMetaDocPartIndexRecord(String database, String identifier, String collection, JsonArray tableRef, Boolean unique) {
		super(DerbyMetaDocPartIndexTable.DOC_PART_INDEX);
