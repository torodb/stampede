...
public class DerbyMetaDocPartIndexTable extends MetaDocPartIndexTable<JsonArray, DerbyMetaDocPartIndexRecord> {
	...
	private DerbyMetaDocPartIndexTable(String alias, Table<DerbyMetaDocPartIndexRecord> aliased, Field<?>[] parameters) {
