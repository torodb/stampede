...
package com.torodb.backend.derby.converters;
 ...
 *
 */
public class DerbyValueToCopyConverter implements KVValueVisitor<Void, StringBuilder> {
    private static final char ROW_DELIMETER = '\n';
    private static final char COLUMN_DELIMETER = '\t';

    public static final DerbyValueToCopyConverter INSTANCE = new DerbyValueToCopyConverter();

    DerbyValueToCopyConverter() {
    }
