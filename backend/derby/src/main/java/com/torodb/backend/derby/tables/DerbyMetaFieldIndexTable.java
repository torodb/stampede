...
public class DerbyMetaFieldIndexTable extends MetaFieldIndexTable<JsonArray, DerbyMetaFieldIndexRecord> {
    ...
    private DerbyMetaFieldIndexTable(String alias, Table<DerbyMetaFieldIndexRecord> aliased, Field<?>[] parameters) {
