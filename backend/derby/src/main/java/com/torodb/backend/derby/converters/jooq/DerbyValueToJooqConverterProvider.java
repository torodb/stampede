 ...
 *
 */
public class DerbyValueToJooqConverterProvider implements ValueToJooqConverterProvider {
    ...
    public static DerbyValueToJooqConverterProvider getInstance() {
        return ValueToJooqConverterProviderHolder.INSTANCE;
    }

    private static class ValueToJooqConverterProviderHolder {

        private static final DerbyValueToJooqConverterProvider INSTANCE
                = new DerbyValueToJooqConverterProvider();
    }

    //@edu.umd.cs.findbugs.annotations.SuppressFBWarnings(value = "UPM_UNCALLED_PRIVATE_METHOD")
    private Object readResolve() {
        return DerbyValueToJooqConverterProvider.getInstance();
    }
}
