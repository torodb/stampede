...
You may download the [latest version][3] (v. 0.15) of ToroDB from ToroDB's maven repository. See below for instructions on how to run it.
...
Just run `mvn package` on the root directory and find the executable jar file in `torodb/target/torodb-0.15-jar-with-dependencies.jar`.
...
[3]: http://maven.torodb.com/jar/com/torodb/torodb/0.15/torodb.jar
