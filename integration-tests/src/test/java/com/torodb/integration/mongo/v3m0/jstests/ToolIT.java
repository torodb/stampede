...
public class ToolIT extends AbstractIntegrationTest {
    ...
    private static ScriptClassifier createScriptClassifier() {
        ...
        return new Builder()
                ...
                .addScripts(MONGO, DERBY, WORKING, workingSet)
                .addScripts(MONGO, DERBY, CATASTROPHIC, catastrophicSet)
                .addScripts(MONGO, DERBY, FALSE_POSITIVE, falsePositiveSet)
                .addScripts(MONGO, DERBY, NOT_IMPLEMENTED, notImplementedSet)
                .addScripts(MONGO, DERBY, IGNORED, ignoredSet)
                .addScripts(MONGO_REPL_SET, DERBY, CATASTROPHIC, allSet)
