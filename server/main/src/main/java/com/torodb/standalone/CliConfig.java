...
public class CliConfig {
  ...
  @Parameter(names = {"-b", "--backend"}, descriptionKey = "backend", validateValueWith =
      BackendValueValidator.class)
  private String backend;
  @Parameter(names = {"-p", "--param"}, descriptionKey = "param", validateValueWith =
      ParamValueValidator.class,
