...
public class ReplicaSetConfig {
    ...
    /**
     * @param maxMembers the maximun numbers of members a replication set should have. It could be
     *                         different on different MongoDB versions.
     ...
     * members where the tag is defined and the value of the tag key is different between them,
     * where <em>i</em> is the value of the tag on the pattern constraint.
     */
