...
public class ConnectionCmdImpl implements CmdImplMapSupplier<MongodConnection> {
  ...
  @Inject
  ConnectionCmdImpl(Clock clock, BuildProperties buildProps, MongodServerConfig mongodServerConf) {
    this(new MapFactory(clock, buildProps, mongodServerConf));
  }

  protected ConnectionCmdImpl(
  ...
  static class MapFactory extends AbstractCommandMapFactory<MongodConnection> {
    ...
    public MapFactory(Clock clock, BuildProperties buildProps,
      ...
      super(
          ...
          new MyDiagnosticCommandsImplementationBuilder(buildProps, mongodServerConfig),
          new MyGeneralCommandsImplementationBuilder(),
          new MyInternalCommandsImplementationsBuilder(),
          new MyReplCommandsImplementationsBuilder(clock, mongodServerConfig)
      );
    }
  ...
  static class MyDiagnosticCommandsImplementationBuilder extends DiagnosticCommandsImplementationsBuilder<MongodConnection> {
    ...
    private final MongodServerConfig mongodServerConfig;

    public MyDiagnosticCommandsImplementationBuilder(BuildProperties buildProperties,
        MongodServerConfig mongodServerConfig) {
      this.buildProperties = buildProperties;
      this.mongodServerConfig = mongodServerConfig;
    }
  ...
  static class MyReplCommandsImplementationsBuilder extends ReplCommandsImplementationsBuilder<MongodConnection> {
    ...
    public MyReplCommandsImplementationsBuilder(Clock clock, MongodServerConfig mongodServerConfig) {
      this.clock = clock;
      this.mongodServerConfig = mongodServerConfig;
    }
    ...
    public CommandImplementation<Empty, IsMasterReply, MongodConnection> getIsMasterImplementation() {
      return new IsMasterImplementation(clock, mongodServerConfig);
    }
