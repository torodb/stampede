...
public class CollModCommand extends AbstractNotAliasableCommand<CollModArgument, CollModResult> {
    ...
    public static class CollModArgument {
        ...
        private static final BooleanField USE_POWER_OF_2_SIZES_FIELD = new BooleanField("usePowerOf2Sizes");
        ...
        public static class CollModArgumentBuilder {
            ...
            public CollModArgumentBuilder(BsonDocument doc) throws TypesMismatchException, NoSuchKeyException, BadValueException {
    ...
    public static class CollModResult {
        ...
        private CollModResult(SortedMap<String, BsonValue<?>> oldValues, SortedMap<String, BsonValue<?>> newValues) {
        ...
        public static class CollModResultBuilder {
            ...
            public CollModResultBuilder addPropery(String propName, BsonValue<?> oldValue, BsonValue<?> newValue) {
