...
public class UpdateActionsTool {
    ...
    public static UpdateAction parseUpdateAction(UpdateOplogOperation updateAction) {
        try {
            ...
            throw new ToroRuntimeException("Unexpected error while analyzing a update oplog operation", ex);
        }
    }
    ...
    private static class MergerProvider implements UpdateActionVisitor<UpdateActionVisitor<UpdateAction, ? extends UpdateAction>, Void> {
        ...
        @Override
        public UpdateActionVisitor<UpdateAction, ? extends UpdateAction> visit(CompositeUpdateAction newAction, Void arg) {
            return COMPOSITE_MERGER;
        }

        @Override
        public UpdateActionVisitor<UpdateAction, ? extends UpdateAction> visit(IncrementUpdateAction newAction, Void arg) {
            return SINGLE_FIELD_MERGER;
        }

        @Override
        public UpdateActionVisitor<UpdateAction, ? extends UpdateAction> visit(MoveUpdateAction newAction, Void arg) {
            return SINGLE_FIELD_MERGER;
        }

        @Override
        public UpdateActionVisitor<UpdateAction, ? extends UpdateAction> visit(MultiplyUpdateAction newAction, Void arg) {
            return SINGLE_FIELD_MERGER;
        }

        @Override
        public UpdateActionVisitor<UpdateAction, ? extends UpdateAction> visit(SetCurrentDateUpdateAction newAction, Void arg) {
            return SINGLE_FIELD_MERGER;
        }

        @Override
        public UpdateActionVisitor<UpdateAction, ? extends UpdateAction> visit(SetDocumentUpdateAction newAction, Void arg) {
            return SET_DOC_MERGER;
        }

        @Override
        public UpdateActionVisitor<UpdateAction, ? extends UpdateAction> visit(SetFieldUpdateAction newAction, Void arg) {
            return SINGLE_FIELD_MERGER;
        }

        @Override
        public UpdateActionVisitor<UpdateAction, ? extends UpdateAction> visit(UnsetFieldUpdateAction newAction, Void arg) {
            return SINGLE_FIELD_MERGER;
        }

    }

    private static class SingleFieldMerger implements UpdateActionVisitor<UpdateAction, SingleFieldUpdateAction> {
        ...
        @Override
        public UpdateAction visit(SetCurrentDateUpdateAction newAction, SingleFieldUpdateAction oldAction) {
            CompositeUpdateAction.Builder builder = new CompositeUpdateAction.Builder();
        ...
        @Override
        public UpdateAction visit(SetDocumentUpdateAction newAction, SingleFieldUpdateAction oldAction) {
            return newAction;
        }
    ...
    private static class CompositeMerger implements UpdateActionVisitor<UpdateAction, CompositeUpdateAction> {
        ...
        @Override
        public UpdateAction visit(SetCurrentDateUpdateAction newAction, CompositeUpdateAction oldAction) {
            CompositeUpdateAction.Builder builder = new CompositeUpdateAction.Builder();
    ...
    private static class SetDocMerger implements UpdateActionVisitor<UpdateAction, SetDocumentUpdateAction> {
        ...
        @Override
        public UpdateAction visit(SetCurrentDateUpdateAction newAction, SetDocumentUpdateAction oldAction) {
            KVDocument newDoc = applyModification(oldAction.getNewValue(), newAction);
            return new SetDocumentUpdateAction(newDoc);
        }

        @Override
        public UpdateAction visit(SetDocumentUpdateAction newAction, SetDocumentUpdateAction oldAction) {
            return newAction;
        }
