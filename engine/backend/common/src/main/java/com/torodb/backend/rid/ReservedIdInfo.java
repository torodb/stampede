...
public class ReservedIdInfo {
  ...
  public boolean equals(Object obj) {
    ...
    if (this.lastUsedId != other.lastUsedId && (this.lastUsedId == null || !this.lastUsedId.equals(
        other.lastUsedId))) {
      return false;
    }
    if (this.lastCachedId != other.lastCachedId && (this.lastCachedId == null || !this.lastCachedId
        .equals(other.lastCachedId))) {
      return false;
    }
    return true;
  }
