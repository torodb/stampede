...
public class DerbyMetaDocPartIndexColumnRecord extends MetaDocPartIndexColumnRecord<JsonArray> {
	 ...
	 */
	public DerbyMetaDocPartIndexColumnRecord(String database, String indexIdentifier, String collection, Integer position, JsonArray tableRef, String identifier, FieldIndexOrdering fieldIndexOrdering) {
		super(DerbyMetaDocPartIndexColumnTable.DOC_PART_INDEX_COLUMN);
    ...
    @Override
    public MetaDocPartIndexColumnRecord<JsonArray> values(String database, String indexIdentifier, Integer position, String collection, JsonArray tableRef, String identifier, FieldIndexOrdering fieldIndexOrdering) {
