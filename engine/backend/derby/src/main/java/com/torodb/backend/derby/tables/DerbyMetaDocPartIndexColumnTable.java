...
public class DerbyMetaDocPartIndexColumnTable extends MetaDocPartIndexColumnTable<JsonArray, DerbyMetaDocPartIndexColumnRecord> {

    private static final long serialVersionUID = -5790340936992206370L;
    /**
     * The singleton instance of <code>torodb.field_index</code>
     */
    public static final DerbyMetaDocPartIndexColumnTable DOC_PART_INDEX_COLUMN = new DerbyMetaDocPartIndexColumnTable();
    ...
    private DerbyMetaDocPartIndexColumnTable(String alias, Table<DerbyMetaDocPartIndexColumnRecord> aliased) {
        this(alias, aliased, null);
    }

    private DerbyMetaDocPartIndexColumnTable(String alias, Table<DerbyMetaDocPartIndexColumnRecord> aliased, Field<?>[] parameters) {
