...
public class DerbyMetaFieldRecord extends MetaFieldRecord<JsonArray> {
   ...
   */
  public DerbyMetaFieldRecord(String database, String collection, JsonArray tableRef, String name,
  ...
  @Override
  public MetaFieldRecord<JsonArray> values(String database, String collection, JsonArray tableRef,
