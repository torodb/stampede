...
public class RoleWithDefaultDeserializer
    extends ScalarWithDefaultDeserializer<Role> {

  @SuppressWarnings("unchecked")
  public RoleWithDefaultDeserializer() {
    super(EnumWithDefault.class, Role.class);
  }
}
