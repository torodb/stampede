...
public class AuthModeWithDefaultDeserializer
    extends ScalarWithDefaultDeserializer<AuthMode> {

  public AuthModeWithDefaultDeserializer() {
    super(EnumWithDefault.class, AuthMode.class);
  }
}
