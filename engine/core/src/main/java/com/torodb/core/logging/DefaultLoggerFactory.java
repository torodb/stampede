...
public class DefaultLoggerFactory extends ComponentLoggerFactory {
  ...
  public static DefaultLoggerFactory getInstance() {
    return DefaultLoggerFactoryHolder.INSTANCE;
  }
  ...
  private static class DefaultLoggerFactoryHolder {
