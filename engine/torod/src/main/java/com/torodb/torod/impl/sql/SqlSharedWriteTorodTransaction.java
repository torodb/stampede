 ...
 *
 */
public class SqlSharedWriteTorodTransaction
    extends SqlWriteTorodTransaction<SharedWriteInternalTransaction> {
  ...
  @Override
  protected SharedWriteInternalTransaction createInternalTransaction(
