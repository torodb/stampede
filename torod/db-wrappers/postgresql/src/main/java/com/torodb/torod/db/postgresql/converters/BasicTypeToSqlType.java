 ...
 *
 */
public class BasicTypeToSqlType {

    private BasicTypeToSqlType() {
    }

    public static BasicTypeToSqlType getInstance() {
        return BasicTypeToSqlTypeHolder.INSTANCE;
    }
    ...
    private static class BasicTypeToSqlTypeHolder {
        private static final BasicTypeToSqlType INSTANCE = new BasicTypeToSqlType();
    }

    //@edu.umd.cs.findbugs.annotations.SuppressFBWarnings(value = "UPM_UNCALLED_PRIVATE_METHOD")
    private Object readResolve()  {
        return BasicTypeToSqlType.getInstance();
    }
 }
