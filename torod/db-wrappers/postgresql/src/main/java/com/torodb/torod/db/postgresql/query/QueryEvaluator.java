...
import com.torodb.torod.db.postgresql.query.dblanguage.AndDatabaseQuery;
import com.torodb.torod.db.postgresql.query.dblanguage.ByStructureDatabaseQuery;
import com.torodb.torod.db.postgresql.query.dblanguage.DatabaseQuery;
import com.torodb.torod.db.postgresql.query.dblanguage.DatabaseQueryVisitor;
import com.torodb.torod.db.postgresql.query.dblanguage.FalseDatabaseQuery;
import com.torodb.torod.db.postgresql.query.dblanguage.OrDatabaseQuery;
import com.torodb.torod.db.postgresql.query.dblanguage.SelectAllDatabaseQuery;
import com.torodb.torod.db.postgresql.query.dblanguage.SelectDatabaseQuery;
...
public class QueryEvaluator {
    ...
    public QueryEvaluator(CollectionSchema colSchema) {
        this.colSchema = colSchema;
        this.toSQLTranslator = new QueryCriteriaToSQLTranslator(colSchema);
    }
