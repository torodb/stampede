...
import com.torodb.torod.db.postgresql.query.Processor;
 ...
 *
 */
public class TrueProcessor {

    public static List<ProcessedQueryCriteria> process(
            TrueQueryCriteria criteria, 
            QueryCriteriaVisitor<List<ProcessedQueryCriteria>, Void> visitor) {
        
        return Collections.singletonList(new ProcessedQueryCriteria(null, null));
    }
}
