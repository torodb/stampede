...
import com.torodb.torod.db.wrappers.postgresql.query.processors.TrueProcessor;
import com.torodb.torod.db.wrappers.postgresql.query.processors.ModIsProcessor;
import com.torodb.torod.db.wrappers.postgresql.query.processors.FalseProcessor;
import com.torodb.torod.db.wrappers.postgresql.query.processors.IsEqualProcessor;
import com.torodb.torod.db.wrappers.postgresql.query.processors.NotProcessor;
import com.torodb.torod.db.wrappers.postgresql.query.processors.OrProcessor;
import com.torodb.torod.db.wrappers.postgresql.query.processors.InProcessor;
import com.torodb.torod.db.wrappers.postgresql.query.processors.SizeIsProcessor;
import com.torodb.torod.db.wrappers.postgresql.query.processors.CompareProcessor;
import com.torodb.torod.db.wrappers.postgresql.query.processors.TypeIsProcessor;
import com.torodb.torod.db.wrappers.postgresql.query.processors.AndProcessor;
import com.torodb.torod.db.wrappers.postgresql.query.processors.ExistsProcessor;
import com.torodb.torod.db.wrappers.postgresql.query.processors.ContainsAttributesProcessor;
import com.torodb.torod.core.language.querycriteria.utils.QueryCriteriaVisitor;

import java.util.List;

import com.torodb.torod.db.wrappers.postgresql.query.processors.*;
