 ...
 *
 */
public class AndDatabaseQuery implements DatabaseQuery {

    private final List<DatabaseQuery> children;

    public AndDatabaseQuery(List<DatabaseQuery> children) {
    ...
    public boolean equals(Object obj) {
        ...
        final AndDatabaseQuery other = (AndDatabaseQuery) obj;
    ...
    public static class Builder {
        ...
        public AndDatabaseQuery build() {
            return new AndDatabaseQuery(children);
        }
    }
