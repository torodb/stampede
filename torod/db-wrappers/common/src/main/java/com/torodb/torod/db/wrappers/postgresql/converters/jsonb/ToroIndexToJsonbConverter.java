 ...
 *
 */
public class ToroIndexToJsonbConverter implements Converter<String, NamedToroIndex> {
    ...
    public ToroIndexToJsonbConverter(String databaseName, String collectionName) {
