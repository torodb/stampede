...
package com.torodb.torod.db.wrappers.metaInf;
 ...
 *
 */
public class DbMetaInformation_CreateSubDocumentTypeTable_FinishJobBeforeContinue_Test extends SequencerTest {
    ...
    public DbMetaInformation_CreateSubDocumentTypeTable_FinishJobBeforeContinue_Test() {
        super(10000l);
    }
    ...
    private void createExecutorFactory() throws ImplementationDbException {
        executorFactory = mock(ExecutorFactory.class, new ThrowExceptionAnswer());
    ...
    private Future<?> whenCreateSubDocTable() {
        ...
        sequencer.notify(MySteps.JOB_CREATED);
        sequencer.waitFor(MySteps.JOB_EXECUTED);
    ...
    public void executorThread() {
        sequencer.waitFor(MySteps.JOB_CREATED);
        Mockito.doReturn(true).when(future).isDone();
        
        sequencer.notify(MySteps.JOB_EXECUTED);
    }
