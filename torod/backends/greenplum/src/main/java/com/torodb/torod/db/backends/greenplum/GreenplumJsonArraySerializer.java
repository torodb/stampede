...
public class GreenplumJsonArraySerializer implements ArraySerializer {
    ...
    public Condition typeof(String fieldName, String typeName) {
        //return DSL.condition("json_typeof(?) = '?'", fieldName, typeName);
        throw new UserToroException("query on arrays are not supported for Greenplum");
    }
    ...
    public Condition arrayLength(String fieldName, Param<?> value) {
        //return DSL.condition("json_array_length(?) = '?'", fieldName, value);
        throw new UserToroException("query on arrays are not supported for Greenplum");
    }
    ...
    public Table arrayElements(Field<?> iteratorVariable, Field<?> field) {
        //return DSL.table("json_array_elements(" + field.toString() + ")").as(iteratorVariable.toString());
        throw new UserToroException("query on arrays are not supported for Greenplum");
    }
