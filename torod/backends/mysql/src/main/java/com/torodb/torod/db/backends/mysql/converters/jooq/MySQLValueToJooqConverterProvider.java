 ...
 *
 */
public class MySQLValueToJooqConverterProvider implements ValueToJooqConverterProvider {
    ...
    public static MySQLValueToJooqConverterProvider getInstance() {
        return ValueToJooqConverterProviderHolder.INSTANCE;
    }

    private static class ValueToJooqConverterProviderHolder {

        private static final MySQLValueToJooqConverterProvider INSTANCE
                = new MySQLValueToJooqConverterProvider();
    }

    //@edu.umd.cs.findbugs.annotations.SuppressFBWarnings(value = "UPM_UNCALLED_PRIVATE_METHOD")
    private Object readResolve() {
        return MySQLValueToJooqConverterProvider.getInstance();
    }
}
