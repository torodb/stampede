 ...
 *
 */
public class MySQLValueToJooqDataTypeProvider implements ValueToJooqDataTypeProvider {
    ...
    public static MySQLValueToJooqDataTypeProvider getInstance() {
        return ValueToJooqDataTypeProviderHolder.INSTANCE;
    }

    private static class ValueToJooqDataTypeProviderHolder {

        private static final MySQLValueToJooqDataTypeProvider INSTANCE
                = new MySQLValueToJooqDataTypeProvider();
    }

    //@edu.umd.cs.findbugs.annotations.SuppressFBWarnings(value = "UPM_UNCALLED_PRIVATE_METHOD")
    private Object readResolve() {
        return MySQLValueToJooqDataTypeProvider.getInstance();
    }
}
