 ...
 *
 */
public class MySQLStructuresCache extends AbstractStructuresCache {

    private static final long serialVersionUID = 1L;

    private static final Field<Integer> sidField = DSL.field("sid", SQLDataType.INTEGER);
    private static final Field<String> structuresField = DSL.field("_structure", new DefaultDataType<String>(null, String.class, "json"));

    public MySQLStructuresCache(
