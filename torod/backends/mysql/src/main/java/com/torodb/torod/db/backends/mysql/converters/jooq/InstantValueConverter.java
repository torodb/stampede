...
public class InstantValueConverter implements SubdocValueConverter<Timestamp, ScalarInstant>{
    ...
    private static final DataType<Timestamp> DATETIME = new DefaultDataType<Timestamp>(null, Timestamp.class, "datetime");

    public static final DataTypeForScalar<ScalarInstant> TYPE = DataTypeForScalar.from(DATETIME, new InstantValueConverter());
