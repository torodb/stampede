 ...
 *
 */
public class MySQLBooleanValueToJsonConverter implements
        ValueConverter<Integer, ScalarBoolean> {

    private static final long serialVersionUID = 1L;

    @Override
    public Class<? extends Integer> getJsonClass() {
    ...
    @Override
    public Integer toJson(ScalarBoolean value) {
        return value.getValue()?1:0;
    }

    @Override
    public ScalarBoolean toValue(Integer value) {
        return ScalarBoolean.from(value != 0);
    }
