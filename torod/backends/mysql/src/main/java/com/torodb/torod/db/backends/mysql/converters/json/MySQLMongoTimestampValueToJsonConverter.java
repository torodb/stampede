 ...
 *
 */
public class MySQLMongoTimestampValueToJsonConverter implements
    ...
    @Override
    public Long toJson(ScalarMongoTimestamp value) {
        return ULong.valueOf(BigInteger.valueOf(value.getSecondsSinceEpoch()).shiftLeft(32).add(BigInteger.valueOf(value.getOrdinal()))).longValue();
    }
