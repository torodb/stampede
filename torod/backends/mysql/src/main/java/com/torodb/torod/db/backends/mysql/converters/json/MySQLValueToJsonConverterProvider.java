 ...
 *
 */
public class MySQLValueToJsonConverterProvider implements ValueToJsonConverterProvider {
    ...
    public static MySQLValueToJsonConverterProvider getInstance() {
    ...
    private static class ValueToJsonConverterProviderHolder {
        ...
        private static final MySQLValueToJsonConverterProvider INSTANCE
                = new MySQLValueToJsonConverterProvider();
    }

    //@edu.umd.cs.findbugs.annotations.SuppressFBWarnings(value = "UPM_UNCALLED_PRIVATE_METHOD")
    private Object readResolve() {
        return MySQLValueToJsonConverterProvider.getInstance();
    }
}
