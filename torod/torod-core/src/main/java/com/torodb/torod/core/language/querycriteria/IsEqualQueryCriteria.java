 ...
 *
 */
public class IsEqualQueryCriteria extends AttributeAndValueQueryCriteria {
    private static final long serialVersionUID = 1L;

    public IsEqualQueryCriteria(AttributeReference attributeReference, ScalarValue<?> val) {
