...
public class OrQueryCriteria extends QueryCriteria {
    ...
    public OrQueryCriteria(@Nonnull QueryCriteria subQueryCriteria1, @Nonnull QueryCriteria subQueryCriteria2) {
    ...
    public String toString() {
        return "(" + subQueryCriteria1 + ") or (" + subQueryCriteria2 + ')';
    }

    @Override
    public int hashCode() {
        int hash = 7;
        hash = 37 * hash + (this.subQueryCriteria1 != null ? this.subQueryCriteria1.hashCode() : 0);
        hash = 37 * hash + (this.subQueryCriteria2 != null ? this.subQueryCriteria2.hashCode() : 0);
        return hash;
    }
    ...
    public boolean semanticEquals(QueryCriteria obj) {
        ...
        final OrQueryCriteria other = (OrQueryCriteria) obj;
