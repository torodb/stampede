...
public interface OplogApplier extends AutoCloseable {
    ...
    public static interface ApplyingJob {
        ...
        /**
         * Returns a future that will be done once the applying process
         * finishes.
         * <p>
         * This future should never finish exceptionally, as all exceptions are
         * captured and returned as a tuple with the
         * {@link ApplyingJobFinishState finish state} and the exception thrown.
         * 
         * @return
         */
        ...
        /**
         * Waits until the applying process finishes, throwing an exception if
         * it fails.
         *
         * @throws StopReplicationException
         * @throws RollbackReplicationException
         * @throws CancellationException           if the execution was
         *                                         cancelled.
         * @throws UnexpectedOplogApplierException if any other throwable was
         *                                         thrown
         * @see #cancel()
         */
         ...
         * <p>
         * If the process does not finishes early by other reason, the
         * {@link #onFinish()} future will finished with a tupple whose first
         * element is {@link ApplyingJobFinishState#CANCELLED}.
         */
        void cancel();
    }
