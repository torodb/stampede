...
public abstract class AnalyzedOp {
     ...
     */
    @Nullable
    public abstract KVDocument calculateDocToInsert(@Nullable Function<AnalyzedOp, KVDocument> fetchedDocFun);
    ...
    /**
     * Returns the error status that should be shown to the user if the operation fail because
     * it expected a match on the database, but the modified document was not there.
     *
