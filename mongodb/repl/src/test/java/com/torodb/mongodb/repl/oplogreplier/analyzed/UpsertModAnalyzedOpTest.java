...
public class UpsertModAnalyzedOpTest extends AbstractAnalyzedOpTest<UpsertModAnalyzedOp>{
    ...
    void andThenInsertTest() {
        andThenInsert((colOp, newDoc, oldDoc) -> {}, (colOp, newDoc) -> {});
    }

    //TODO: Callback checks can be improved
    @Override
    void andThenUpdateModTest() {
        andThenUpdateMod((colOp, newDoc, oldDoc) -> {}, (colOp, newDoc) -> {});
    }

    //TODO: Callback checks can be improved
    @Override
    void andThenUpdateSetTest() {
        andThenUpdateSet((colOp, newDoc, oldDoc) -> {}, (colOp, newDoc) -> {});
    }

    //TODO: Callback checks can be improved
    @Override
    void andThenUpsertModTest() {
        andThenUpsertMod((colOp, newDoc, oldDoc) -> {}, (colOp, newDoc) -> {});
    }

    //TODO: Callback checks can be improved
    @Override
    void andThenUpsertSetTest() {
        andThenUpsertSet((colOp, newDoc, oldDoc) -> {}, (colOp, newDoc) -> {});
    }

    //TODO: Callback checks can be improved
    @Override
    void andThenDeleteTest() {
        andThenDelete((colOp, newDoc, oldDoc) -> {}, (colOp, newDoc) -> {});
    }
