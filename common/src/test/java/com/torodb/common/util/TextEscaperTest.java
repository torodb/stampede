...
public class TextEscaperTest {
    ...
    public void testComplexEscape() {
        String text = "Lorem ipsum dolor sit amet, " + ZERO_CHARACTER
                ...
                + "quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat. " + ESCAPE_CHARACTER
                + "Quis aute iure reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. "
                + "Excepteur sint obcaecat cupiditat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.";
        String encodedText = ESCAPER.escape(text);
        Assert.assertEquals("Lorem ipsum dolor sit amet, " + ESCAPE_CHARACTER + "0"
                ...
                + "quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat. " + ESCAPE_CHARACTER + "1"
                + "Quis aute iure reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. "
                + "Excepteur sint obcaecat cupiditat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", 
                encodedText);
        String decodedText = ESCAPER.unescape(encodedText);
    ...
    public void testVeryComplexEscape() {
        String text = "Lorem ipsum dolor sit amet, " + COPY_ESCAPE_CHARACTER
                ...
                + "quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat. " + ESCAPE_CHARACTER
                + "Quis aute iure reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. " + CARRIAGE_RETURN_CHARACTER
                + "Excepteur sint obcaecat cupiditat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.";
        String encodedText = ESCAPER.escape(text);
        Assert.assertEquals("Lorem ipsum dolor sit amet, " + COPY_ESCAPE_CHARACTER + COPY_ESCAPE_CHARACTER
                + "consectetur adipiscing elit, " + ESCAPE_CHARACTER + "0"
                + "sed eiusmod tempor incidunt ut labore et dolore magna aliqua. " + ESCAPE_CHARACTER + "1"
                + "Ut enim ad minim veniam, " + COPY_ESCAPE_CHARACTER + COLUMN_DELIMETER_CHARACTER
                + "quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat. " + ESCAPE_CHARACTER + "1"
                + "Quis aute iure reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. " + COPY_ESCAPE_CHARACTER + CARRIAGE_RETURN_CHARACTER
                + "Excepteur sint obcaecat cupiditat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", 
                encodedText);
        String decodedText = ESCAPER.unescape(encodedText);
        Assert.assertEquals(
