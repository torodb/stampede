...
public interface DocTypeVisitor<Result, Arg> {
    ...
    public <Result, Arg> Result visit(BooleanType type, Arg arg);
    ...
    public Result visit(ObjectType type, Arg arg);

    public Result visit(StringType type, Arg arg);
    
    public Result visit(GenericType type, Arg arg);
    
    public Result visit(TwelveBytesType type, Arg arg);
    
    public Result visit(DateTimeType type, Arg arg);
